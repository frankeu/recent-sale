...
echo 'var recentSales = '.json_encode($result).';setInterval(function(){var o=recentSales[Math.random()*recentSales.length|0];document.getElementById("random").innerHTML=o,$(".custom-social-proof").slideToggle("fast")},5e3),$(".custom-close").click(function(){$(".custom-social-proof").stop().slideToggle("fast")});';
